...
public class CreateAsn {
      ...
      private String receiving_type;//Option 入库单类型：D:自发头程,T中转代发

      private String warehouse_code;//Require 目的仓

      private String transit_warehouse_code;//Option 中转仓库，中转代发时，必填

      private String sm_code ;//Option 物流产品，中转代发时，必填
      ...
      private String contract_no;//Option 入库单合同号(选填)

      private String receiving_attachment;//Option 入库单附件oss地址(单文件)

      private String vat_tax_code;//Option VAT税号

      private String incoming_order_goods_type;//Option 入库单货物类型：1:整柜;2:散柜,3:退货,默认为0(定制接口参数：如无忧达客户在使用)

      private String spontaneous_head_cheng_type;//Option 自发头程类型：1:无忧达自发;2:客户自发,默认为0(自发头程时必填12中一项)(定制接口参数：如无忧达客户在使用)
      ...
      private String stock_type;//Option 入库单库存类型：默认0=以仓库为准,1=标准区,2=暂存区,5=以箱为准(注意前三种库存类型是按单维度，所有箱都是同种库存类型；以箱为准库存类型,是与item.inventory_type参数组合使用)
      ...
      public void setReceiving_type(String receiving_type) {
      ...
      public String getReceiving_attachment() {
            return receiving_attachment;
      }

      public void setReceiving_attachment(String receiving_attachment) {
            this.receiving_attachment = receiving_attachment;
      }
      ...
      public String getIncoming_order_goods_type() {
            return incoming_order_goods_type;
      }

      public void setIncoming_order_goods_type(String incoming_order_goods_type) {
            this.incoming_order_goods_type = incoming_order_goods_type;
      }

      public String getSpontaneous_head_cheng_type() {
            return spontaneous_head_cheng_type;
      }

      public void setSpontaneous_head_cheng_type(String spontaneous_head_cheng_type) {
            this.spontaneous_head_cheng_type = spontaneous_head_cheng_type;
      }
